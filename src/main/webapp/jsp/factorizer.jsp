...
<html>
    ...
    <body>
        ...
        <div class ="container rounded">    
            <h1 class="text-center">Factorizer</h1>
            <div class="col-sm-offset-4 col-sm-4">
                <sf:form class="form-horizontal form-group" modelAttribute="f" action ="runFactorizer" method="post">
                <table class="table table-bordered table-striped">
                        <tr>
                            <td class="col-sm-6">
                                <label for="numberBox" class="control-label">Number to Factorize:</label>
                            </td>
                            <td class="col-sm-6">
                                <sf:input class="form-control" type="number" min="1" path="number" id="numberBox"/>
                                <sf:errors path="number" cssClass="errors"></sf:errors>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2" class="text-center"><input class="btn btn-primary form-control" type="submit" id="startButton" value="Factorize It"/></td>
                        </tr>
                </table>
                </sf:form>      
            </div>
